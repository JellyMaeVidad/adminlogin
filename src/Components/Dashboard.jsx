    ...
    <div className='container-fluid'>
       <div className='row flex-nowrap'>
         <div className='col-auto col-md-3 col-xl-3 px-sm-2 px-0 bg-dark'>
           ...
           <li className='w-100'>
              <Link to="/dashboard/addDelRes" className='nav-link px-0 align-middle text-white'>
                    <i className=" fs-4 bi bi-archive ms-2"></i>  
                    <span className='ms-2 d-none d-sm-inline'>Add/Delete User</span>
              </Link>
           </li>

           <li className='w-100'>
              <Link to="/dashboard/requests" className='nav-link px-0 align-middle text-white'>
                    <i className="fs-4 bi bi-file-earmark-break ms-2"></i> 
                    <span className='ms-2 d-none d-sm-inline'>Document Requests</span> 
              </Link>
           </li>
        ...
        <div className='col p-0 m-0'>
            <div className='p-2 d-flex justify-content-center shadow bg-black text-white'>
               <h4>Purok Registration System</h4>
            </div>
            <Outlet />
        </div>
      </div>
